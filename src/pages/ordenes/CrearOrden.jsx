    ...
    for (const [grupoKey, grupo] of Object.entries(alternativasPorGrupo)) {
      ...
      const { data, error } = await supabase
        ...
        .insert({
          ...
          // Toda orden nueva parte con 1 copia
          copia: 1,
        ...
        {selectedCliente && selectedCampana && (
          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
            ...
            >
              ...
              <Typography variant="subtitle1">
                <strong>Agencia:</strong> {selectedCampana.Agencias?.NombreIdentificador || 'No especificada'}
              </Typography>
              </Box>
                ...
                {selectedCampana ? (
                  <TableContainer sx={{ 
                    ...
                    <Table size="small" sx={{ width: '100%', tableLayout: 'fixed' }}>
                      <TableHead>
                        <TableRow>
                          <TableCell sx={{ width: '25%', fontWeight: 'bold' }}>Nombre</TableCell>
                          <TableCell sx={{ width: '15%', fontWeight: 'bold' }}>Año</TableCell>
                          <TableCell sx={{ width: '20%', fontWeight: 'bold' }}>Mes</TableCell>
                          <TableCell sx={{ width: '50%', fontWeight: 'bold', textAlign: 'left' }}>Acción</TableCell>
                        </TableRow>
                      </TableHead>
                      <TableBody>
                        {planes.map((plan) => (
                          ...
                          >
                            ...
                            <TableCell sx={{ textAlign: 'center',  textAlign: 'left' }}>
                              <Button
                                size="small"
                                variant="contained"
                                color="primary"
