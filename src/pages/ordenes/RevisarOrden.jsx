...
const RevisarOrden = () => {
    ...
    const handleCancel = async () => {
        ...
        const result = await Swal.fire({
            title: '¿Está seguro?',
            text: "Esta acción anulará todas las alternativas de la orden seleccionada",
            icon: 'warning',
        ...
        if (result.isConfirmed) {
            try {
                ...
                Swal.fire(
                    'Anulado',
                    'Las alternativas de la orden han sido anuladas',
                    'success'
                );
                ...
                Swal.fire({
                    icon: 'error',
                    title: 'Error',
                    text: 'No se pudieron anular las alternativas'
                });
            }
        }
    };
