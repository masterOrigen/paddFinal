...
const ModalEditarContrato = ({ open, onClose, contrato, onContratoUpdated, clienteId, clienteNombre, disableClienteSelect }) => {
        ...
        const fetchData = async () => {
            ...
            try {
                ...
                if (!disableClienteSelect) {
                    ...
                    // Si hay un clienteId y clienteNombre, asegurarse de que esté en la lista
                    if (clienteId && clienteNombre) {
                        const clienteExiste = clientesData.some(c => c.id_cliente === clienteId);
                        if (!clienteExiste) {
                            clientesData.unshift({ id_cliente: clienteId, nombreCliente: clienteNombre });
                        }
                    }
    ...
    }, [open, disableClienteSelect, clienteId, clienteNombre]);
    useEffect(() => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const fechaInicioAjustada = formData.FechaInicio ? `${formData.FechaInicio}T12:00:00` : null;
            const fechaTerminoAjustada = formData.FechaTermino ? `${formData.FechaTermino}T12:00:00` : null;
            ...
            const { error } = await supabase
                ...
                .update({
                    ...
                    FechaTermino: fechaTerminoAjustada,
