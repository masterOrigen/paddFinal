...
const Alternativas = () => {
  ...
  const fetchAlternativas = async () => {
    try {
      ...
      if (annulledError) {
        console.error('Error al obtener órdenes anuladas:', annulledError);
      }
      ...
      console.log('IDs de alternativas en órdenes anuladas:', annulledAlternativeIds);
      ...
      console.log('Alternativas obtenidas (filtradas):', filteredData);
