...
const Planificacion = () => {
    ...
    try {
      ...
      if (!isAdmin && esMesCerrado(duplicatePlanData.anio, duplicatePlanData.mes)) {
        Swal.fire({
          icon: 'warning',
          title: 'Mes cerrado',
          text: 'No se pueden duplicar planes hacia un mes cerrado.'
        });
        return;
      }
    ...
    try {
      ...
      if (!isAdmin && esMesCerrado(nuevoPlan.anio, nuevoPlan.mes)) {
        Swal.fire({
          icon: 'warning',
          title: 'Mes cerrado',
          text: 'Este mes está cerrado. No se pueden crear planes para meses cerrados.'
        });
        return;
      }
  ...
  const handleEditPlan = (plan) => {
    setEditingPlan({
      ...
      original_anio: plan.anio,
      original_mes: plan.mes
    });
                          ...
                          <TableCell align="center">
                            <Box sx={{ display: 'flex', gap: 1, justifyContent: 'center' }}>
                              <IconButton
                                ...
                                size="small"
                                title="Editar plan"
                                disabled={plan.estado2 === 'aprobado' || bloquearAcciones}
                              >
                                <EditIcon />
                              </IconButton>
                              <IconButton
                              ...
                              <IconButton
                                ...
                                size="small"
                                title="Cancelar"
                                disabled={plan.estado2 === 'cancelado' || bloquearAcciones}
                              >
                                <CancelIcon />
                              </IconButton>
                              <IconButton
                              ...
                              <IconButton
                                ...
                                size="small"
                                title="Eliminar plan"
                                disabled={(plan.estado2 === 'aprobado' || (plan.plan_alternativas && plan.plan_alternativas.length > 0)) || bloquearAcciones}
                              >
                                <DeleteIcon />
                              </IconButton>
                            </Box>
