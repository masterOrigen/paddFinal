...
const Agencias = () => {
  ...
  const fetchData = async () => {
    try {
      setLoading(true);
      const [
        { data: agenciasData, error: agenciasError },
      ...
      const transformedData = agenciasData.map(agencia => ({
        ...
        fechaCreacion: agencia.created_at ? new Date(agencia.created_at).toLocaleDateString('es-CL', { day: '2-digit', month: '2-digit', year: '2-digit' }) : ''
      }));
