            ...
            <Table size="small" sx={{ width: '100%', tableLayout: 'auto' }}>
              <TableHead>
                <TableRow>
                  <TableCell>Año</TableCell>
                  <TableCell>Mes</TableCell>
                  {isAdmin && <TableCell align="left" sx={{ width: 170, minWidth: 170, whiteSpace: 'nowrap' }}>Acción</TableCell>}
                </TableRow>
              </TableHead>
              <TableBody>
                {mesesBloqueadosLoading ? (
                  ...
                  mesesBloqueadosRows.map((row) => (
                    <TableRow key={`${row.anioId}-${row.mesId}`}>
                      ...
                      {isAdmin && (
                        <TableCell align="left" sx={{ width: 170, minWidth: 170, whiteSpace: 'nowrap' }}>
                          <Button
                            variant="outlined"
                            size="small"
                            color="error"
